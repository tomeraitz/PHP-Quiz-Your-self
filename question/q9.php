...
<head>
	...
	<script>
		function openLogin1(){
			window.location = "../dbTransfer/count.php?count=7";
		}
	...
	<div id="q1">
			<form class="modal-content animate" action="" method="post">
				<div  style="background-image:teacher.jpg;" class="container-fluid">
					<label for="firstName"><h1>Agree/not agree: I love to work in front of a computer and not in front of people</h1></label>
						...
						<center>
							...
							<input type="button" onclick="openLogin2()"  style="white-space: normal"	value="If necessary sometimes" id="a2" class="form-control" placeholder="agree" name="a2"><br>
							<br><input type="button" onclick="openLogin3()" style="white-space: normal" value="I try hard not to but sometimes I must" id="a3" class="form-control" placeholder="agree" name="a3">
